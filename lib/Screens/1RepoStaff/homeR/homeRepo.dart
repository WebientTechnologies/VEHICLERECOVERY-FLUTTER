                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Hey ${uc.userDetails['role'] == 'office-staff' ? uc.userDetails['staf']['name'] : uc.userDetails['agent']['name']}',
                          ...
                          onChanged: (value) {
                            if (value.length >= 12) {
                              if (isOnline) {
                                ...
                                if (sc.searchbyChasisNoModel.value.data !=
                                        null &&
                            ...
                            child: GridView.builder(
                              ...
                              gridDelegate:
                                  const SliverGridDelegateWithFixedCrossAxisCount(
                                      ...
                                      childAspectRatio: 5),
                              itemCount:
                                  sc.searchbylastModel.value.data!.length,
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  onTap: () {
                                    Get.toNamed(
